...
export interface State{
  uploadArr: Array<{id: number, ImagePrivew: string, isShowuploadImg: boolean }>;
}
export default class Test extends Taro.Component<Props, State> {
  constructor() {
    super(...arguments)
    this.state = {
      uploadArr: [
          ...
          return (
            <View key={index}>
              <View className='upload'>
                ...
                />
                <Label for='file' className='ant-upload'>
                  {item.isShowuploadImg ? (
                    <View className='imagePreview'>
                      <Image src={item.ImagePrivew} mode='widthFix' />
